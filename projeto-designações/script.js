...
function salvarNoStorage() {
    ...
    document.querySelectorAll('#corpo-tabela tr').forEach(tr => {
        ...
        linhas.push({
            ...
            auditorio_palco_volante: tds[3].innerText,
...
function adicionarLinhaATabela(obj) {
    ...
    novaLinha.innerHTML = `
        ...
        <td>${obj.entrada}</td>
        <td>${obj.auditorio_palco_volante}</td>
        <td>${obj.leitor}</td>
    ...
    novaLinha.querySelector('.btn-editar').addEventListener('click', function() {
        ...
        document.getElementById('auditorio_palco_volante').value = obj.auditorio_palco_volante;
...
btnAdicionar.addEventListener('click', function() {
    ...
    const dados = {
        ...
        auditorio_palco_volante: document.getElementById('auditorio_palco_volante').value,
    ...
    if (linhaEmEdicao) {
        ...
        linhaEmEdicao.cells[3].innerText = dados.auditorio_palco_volante;
        linhaEmEdicao.cells[4].innerText = dados.leitor;
        linhaEmEdicao.cells[5].innerText = dados.audioVideo;
...
btnPDF.addEventListener('click', async function () {
    ...
    try {
        ...
        doc.autoTable({
            ...
            columns: [0, 1, 2, 3, 4, 5], // Atualizado para 6 colunas de dados
